...
export default function () {
  ...
  const endpoints = [
    ...
    { weight: 25, fn: () => http.get(`${BASE_URL}/games?organizationId=${ORG_ID}`, { headers }) },
    { weight: 20, fn: () => http.get(`${BASE_URL}/projects?organizationId=${ORG_ID}`, { headers }) },
    { weight: 15, fn: () => http.get(`${BASE_URL}/members?organizationId=${ORG_ID}`, { headers }) },
    { weight: 10, fn: () => http.get(`${BASE_URL}/kaizens?organizationId=${ORG_ID}`, { headers }) },
  ];
