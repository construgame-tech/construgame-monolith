...
ALTER TABLE "reusable_checklist_templates" ADD CONSTRAINT "reusable_checklist_templates_organization_id_organizations_id_fk" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "leagues_organization_id_idx" ON "leagues" USING btree ("organization_id");--> statement-breakpoint
